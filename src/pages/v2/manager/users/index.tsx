...
function UsersManagerContent() {
  ...
  const handleDeleteSeller = async (sellerId: string, sellerName: string) => {
    try {
      ...
      const response = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/sellers/${sellerId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleUserFormSubmit = async () => {
    ...
    try {
      ...
      const sellerResponse = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/sellers/${userFormData.id}`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!Number.isNaN(saldoNumber)) {
        ...
        const walletResponse = await fetch(
          `https://shadowpay-delta.vercel.app/api/admin/wallets/${userFormData.id}/adjust-balance`,
          {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json",
  ...
  const fetchAdquerers = async () => {
    try {
      ...
      const response = await fetch(
        "https://shadowpay-delta.vercel.app/api/admin/adquerers",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  useEffect(() => {
    const fetchSellers = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://shadowpay-delta.vercel.app/api/admin/sellers?${queryParams.toString()}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const fetchSellers = async (page = 1) => {
    try {
      ...
      const response = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/sellers?${queryParams}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const approveKyc = async (kycId: string) => {
    try {
      ...
      const response = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/kyc/${kycId}/approve`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const rejectKyc = async (kycId: string, reason: string) => {
    try {
      ...
      const response = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/kyc/${kycId}/reject`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateSellerFees = async (sellerId: string, feesData: typeof fees) => {
    try {
      ...
      const response = await fetch(
        `https://shadowpay-delta.vercel.app/api/admin/sellers/${sellerId}/fees`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    <div className="min-h-screen bg-background text-foreground">
      <SidebarProvider>
        ...
        <SidebarInset>
          ...
          <div className="flex flex-1 flex-col gap-6 p-4 pt-0 min-h-screen bg-background">
            {/* Título */}
