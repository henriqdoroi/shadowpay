...
export function ManagerDashboardContent() {
      ...
      try {
        ...
        do {
          const res = await fetch(
            `https://api.safira.cash/api/admin/sellers?page=${page}`,
            {
  ...
  useEffect(() => {
    async function fetchAdquirentes() {
      try {
        ...
        const res = await fetch("https://api.safira.cash/api/admin/adquerers", {
          headers: { Authorization: `Bearer ${token}` },
        });
        const json = await res.json();
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const url = `https://api.safira.cash/api/admin/dashboard/stats${
      ...
      const fetchTransactions = async (): Promise<Transaction[]> => {
        try {
          ...
          const res = await axios.get(
            "https://api.safira.cash/api/admin/transactions",
            {
              headers: { Authorization: `Bearer ${token}` },
              params: {
